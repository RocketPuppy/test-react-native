// Type definitions for react-native-ble-plx v1.0.0
// Definitions by: Daniel Wilson-Thomas

declare module "react-native-ble-plx" {
  type Optional<X> = X | null | undefined;
  ...
  class BleError extends Error {
     ...
     */
    errorCode: BleErrorCode[keyof BleErrorCode];
    /**
     * Platform independent error code related to ATT errors.
     */
    attErrorCode: Optional<BleATTErrorCode[keyof BleATTErrorCode]>;
    /**
     * iOS specific error code (if not an ATT error).
     */
    iosErrorCode: Optional<BleIOSErrorCode[keyof BleIOSErrorCode]>;
    /**
     * Android specific error code (if not an ATT error).
     */
    androidErrorCode: Optional<BleAndroidErrorCode[keyof BleAndroidErrorCode]>;
    /**
   ...
   */
  type RefreshGattMoment = 'OnConnected'
  ...
  export interface BleManagerOptions {
     ...
     * @instance
     */
    restoreStateFunction?: (restoredState: Optional<BleRestoredState>) => void;
  ...
  export interface ScanOptions {
     ...
     * @instance
     */
    scanMode?: ScanMode[keyof ScanMode];
     ...
     * @instance
     */
    callbackType?: ScanCallbackType[keyof ScanCallbackType];
  }
  ...
  export class BleManager {
     ...
     */
    enable(transactionId: Optional<TransactionId>): Promise<BleManager>;
     ...
     * @returns {Promise<BleManager>} Promise completes when state transition was successful.
     */
    disable(transactionId: Optional<TransactionId>): Promise<BleManager>;
     ...
     */
    onStateChange(listener: (newState: keyof State) => void, emitCurrentState: boolean): Subscription;
     ...
     */
    startDeviceScan(
      UUIDs: Optional<Array<UUID>>,
      options: Optional<ScanOptions>,
      listener: (error: Optional<BleError>, scannedDevice: Optional<Device>) => void
    ): void;
    ...
    requestConnectionPriorityForDevice(
      ...
      connectionPriority: ConnectionPriority[keyof ConnectionPriority],
     ...
     */
    readRSSIForDevice(deviceIdentifier: DeviceId, transactionId: Optional<TransactionId>): Promise<Device>;
     ...
     */
    requestMTUForDevice(deviceIdentifier: DeviceId, mtu: number, transactionId: Optional<TransactionId>): Promise<Device>;
     ...
     */
    devices(deviceIdentifiers: Array<DeviceId>): Promise<Array<Device>>;
     ...
     */
    connectedDevices(serviceUUIDs: Array<UUID>): Promise<Array<Device>>;
     ...
     */
    connectToDevice(deviceIdentifier: DeviceId, options: Optional<ConnectionOptions>): Promise<Device>;
     ...
     * @returns {Subscription} Subscription on which `remove()` function can be called to unsubscribe.
     */
    onDeviceDisconnected(deviceIdentifier: DeviceId, listener: (error: Optional<BleError>, device: Device) => void): Subscription;
     ...
     * {@link Device}.
     */
    servicesForDevice(deviceIdentifier: DeviceId): Promise<Array<Service>>;
    ...
    monitorCharacteristicForDevice(
      ...
      serviceUUID: UUID,
      characteristicUUID: UUID,
      listener: (error: Optional<BleError>, characteristic: Optional<Characteristic>) => void,
      transactionId: Optional<TransactionId>
    ): Subscription;
  }
  /**
  ...
  export class Characteristic {
     ...
     */
    read(transactionId: Optional<TransactionId>): Promise<Characteristic>;
     ...
     */
    writeWithResponse(valueBase64: Base64, transactionId: Optional<TransactionId>): Promise<Characteristic>;
     ...
     * not be stored inside returned object.
     */
    writeWithoutResponse(valueBase64: Base64, transactionId: Optional<TransactionId>): Promise<Characteristic>;
  ...
  export class Device {
     ...
     */
    txPowerLevel: Optional<number>;

    /**
     * List of solicited service UUIDs.
     */
    solicitedServiceUUIDs: Optional<Array<UUID>>;

    /**
     * Is device connectable. [iOS only]
     */
    isConnectable: Optional<boolean>;

    /**
     * List of overflow service UUIDs. [iOS only]
     */
    overflowServiceUUIDs: Optional<Array<UUID>>;
     ...
     */
    readRSSI(transactionId: Optional<TransactionId>): Promise<Device>;
     ...
     * @returns {Promise<Device>} Device with updated MTU size. Default value is 23.
     */
    requestMTU(mtu: number, transactionId: Optional<TransactionId>): Promise<Device>;
     ...
     * @returns {Promise<Device>} Connected {@link Device} object if successful.
     */
    connect(options: Optional<ConnectionOptions>): Promise<Device>;
     ...
     * @returns {Subscription} Subscription on which `remove()` function can be called to unsubscribe.
     */
    onDisconnected(listener: (error: Optional<BleError>, device: Device) => void): Subscription;
     ...
     * characteristics have been discovered.
     */
    discoverAllServicesAndCharacteristics(transactionId: Optional<TransactionId>): Promise<Device>;
     ...
     * discovered for a {@link Device} in specified {@link Service}.
     */
    characteristicsForService(serviceUUID: string): Promise<Array<Characteristic>>;
  ...
  export class Service {
     ...
     */
    readCharacteristic(characteristicUUID: UUID, transactionId: Optional<TransactionId>): Promise<Characteristic>;
